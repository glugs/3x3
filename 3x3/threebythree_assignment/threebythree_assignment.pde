...
float bub1X, bub1Y, bub1Diameter, bub2X, bub2Y, bub2Diameter, bub3X, bub3Y, bub3Diameter,bub4X, bub4Y, bub4Diameter,scoopX, scoopY, scoopDiameter;
...
float cButtonWidth, cButtonHeight, cButton1X, cButton1Y, cButton2X, cButton2Y, cButton3X, cButton3Y,cButton4X, cButton4Y, button5X, button5Y, button6X, button6Y, button6Width, button6Height, button8X, button8Y, button8Width, button8Height, button9X, button9Y, button9Width, button9Height;
...
float image1X, image1Y, image2X, image2Y, image3X, image3Y, image4X, image4Y, image5X, image5Y, image6X, image6Y,image8X, image8Y, imageWidth, imageHeight;
...
void setup() {
  ...
  //file.play(1);
  variablePopulation();
  int smallerScreen=2000;
  if(width>displayWidth) ;
  boxFont = createFont ("Cambria", width/25);
  println("here:", width/25);
...
void mousePressed() {
  ...
  if ( mouseX>=button8X && mouseX<=button8X+button8Width && mouseY>=button8Y && mouseY<=button8Y+button8Height) box2On = true;
  //
